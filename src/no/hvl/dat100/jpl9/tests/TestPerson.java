...
public class TestPerson {
	...
	public void testConstructor() {
		...
		assertEquals(person.getEtternavn(), "Olsen");
		assertEquals(person.getFornavn(), "Ole");
		assertEquals(person.getFnummer(), Long.valueOf(fnummer));
	}
	...
	public void testSet() {
		...
		person.setEtternavn("Olsen");
		person.setFornavn("Ole");
		person.setFnummer(fnummer);
